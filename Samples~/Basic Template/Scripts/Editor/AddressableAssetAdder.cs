...
namespace DevelopKit.BasicTemplate
{
    ...
    public class AddressableAssetAdder
    {
        ...
        private static void AddressableAssetAdderHandler()
        {
            ...
            {
                string assetPath = $"{PackageInstaller.AssetSampleRoot}/Basic Template/AddressableAssetsData/AssetGroups/DevelopKit_Basic_Template.asset";
